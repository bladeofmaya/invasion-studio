...
export default class extends ApplicationController {
  static targets = ["container", "panelTitle", "filterDropdown", "filterSelect", "sortDropdown", "sortSelect", "groupExport", "uploadButton", "searchControls", "searchInput", "tagFilter", "ratingFilter", "resultFilter", "emptyTrashBtn", "clipCount"]
  static values = {
